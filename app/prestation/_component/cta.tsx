    ...
    <div className=" py-16">
      <div className="max-w-6xl flex flex-col items-center mx-auto px-4 text-center">
        ...
        <div className="flex justify-center gap-6 max-sm:flex-col">
          <Link href="/contact">
            <button className="flex hover:cursor-pointer items-center font-semibold bg-[#ffffff] text-[#aa5949] border-2 border-[#aa5949] px-6 py-1 rounded-md shadow-lg hover:bg-[#aa4c4c] hover:text-[#ffffff] transition duration-300">
              Réserver une séance
          ...
          >
            <button className="flex hover:cursor-pointer items-center font-semibold bg-[#aa5949] text-[#ffffff] px-6 py-1 border-2 border-[#aa5949] rounded-md shadow-lg hover:bg-[#aa4c4c] transition duration-300">
          ...
          <a href="https://wa.me/+123456789">
            <button className="flex hover:cursor-pointer items-center font-semibold bg-[#aa5949] text-[#ffffff] px-6 py-1 border-2 border-[#aa5949] rounded-md shadow-lg hover:bg-[#aa4c4c] transition duration-300">
              <FontAwesomeIcon icon={faPhone} className="mr-3 fa-s" />
              Whatsapp
            </button>
          </a>
        </div>
