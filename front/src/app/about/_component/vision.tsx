      ...
      <div className="flex flex-col justify-center mx-auto py-16 px-4 bg-gray-100">
        <div className="flex flex-col items-center">
          ...
          <Link href="/book" legacyBehavior>
            <button
              className="group flex items-center border-[#aa5949] bg-[#aa5949] text-[#f9f8f7] px-6 py-2 font-semibold rounded-sm hover:bg-[#aa4c4c] transition duration-300 mt-10 shadow-md focus:outline-none focus:ring-2 focus:ring-[#aa5949]"
