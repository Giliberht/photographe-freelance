...
import Trust from "@/lib/trustnoteData";
      ...
      <div className="flex flex-col justify-center max-w-6xl mx-auto py-16 px-4">
        <div className="flex flex-col items-center">
          ...
          <Link href="/contact" legacyBehavior>
            <button className="group flex items-center border-[#aa5949] bg-[#aa5949] text-[#f9f8f7] px-6 py-2 font-semibold rounded-sm hover:bg-[#aa4c4c] transition duration-300 mt-10 shadow-lg">
              Réserver une séance
              <FontAwesomeIcon
                icon={faChevronRight}
