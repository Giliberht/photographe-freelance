    ...
    <div className=" py-16">
      <div className="max-w-6xl flex flex-col items-center mx-auto px-4 text-center">
        ...
        <div className="flex justify-center gap-6 max-sm:flex-col">
          ...
          >
            <button className="flex items-center bg-[#aa5949] text-[#ffffff] px-6 py-1 border-2 border-[#aa5949] rounded-md shadow-lg hover:bg-[#aa4c4c] transition duration-300">
              Envoyer un email
