...
import services from "@/lib/seanceData";
import {
  Select,
  SelectContent,
  SelectItem,
      ...
      <div className="flex flex-col items-center max-w-6xl mx-auto mt-20">
        ...
        <div className="flex flex-col items-center">
          ...
          <Link href="/contact" legacyBehavior>
            <button
              className="group border-[#aa5949] bg-[#aa5949] text-[#f9f8f7] px-6 py-2 font-semibold rounded-sm hover:bg-[#aa4c4c] transition duration-300 mt-10 shadow-md mb-8"
