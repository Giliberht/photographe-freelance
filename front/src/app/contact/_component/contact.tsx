      ...
      <div className="flex flex-col items-center mx-auto px-4 py-28">
        <div className="grid grid-cols-2 items-start gap-5">
          ...
          <div className="mx-auto px-4 flex flex-col items-center">
            ...
            <div className="bg-white px-8 rounded-lg border border-black/10 shadow-md hover:shadow-lg transition-shadow duration-300 relative">
              <form className="contact-form py-8" onSubmit={handleSubmit}>
                ...
                <p className="mt-4 text-sm text-muted-foreground">
                  ...
                  <a
                    ...
                    className="text-[#aa4c4c] underline"
                  >
